...
def appointment_request(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "POST" and form.is_valid():
        ...
        if service is None:
            form.add_error("service", _("Selecione um serviço válido."))
        else:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": _("Solicitar consulta"),
            "form": form,
            "submit_label": _("Solicitar consulta"),
        },
    )
...
def reminder_preferences(request: HttpRequest) -> HttpResponse:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": _("Preferências de lembrete"),
            "form": form,
            "preferences": preferences,
            "submit_label": _("Salvar preferência"),
        },
    )
...
def conversation_create(request: HttpRequest) -> HttpResponse:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": _("Nova conversa"),
            "form": form,
            "submit_label": _("Iniciar conversa"),
            "non_emergency_notice": NON_EMERGENCY_NOTICE,
        },
    )
...
def conversation_detail(request: HttpRequest, conversation_id: UUID) -> HttpResponse:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": conversation.subject or _("Conversa"),
            "conversation": conversation,
            "messages": page_obj.object_list,
            "page_obj": page_obj,
            "form": form,
            "submit_label": _("Enviar"),
            "non_emergency_notice": NON_EMERGENCY_NOTICE,
