...
def patient_onboarding(request: HttpRequest) -> HttpResponse:
    ...
    bound_form: Form | None = None
    submitted_step: str | None = None
    ...
    if step == "goals":
        context["form"] = bound_form or PatientGoalsForm(
            initial={"goals": "\n".join(onboarding.goals) if onboarding else ""}
        )
    elif step == "preferences":
        context["form"] = bound_form or PatientPreferencesForm(
            initial={
                "contact_preferences": (
