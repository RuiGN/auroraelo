...
def revocation_work_queue(request: HttpRequest) -> HttpResponse:
    ...
    rows: list[RevocationWorkRow] = [
        {
            "work_item": work_item,
            "purpose_label": purpose_label_pt_br(
                work_item.dispatch.manifestation.purpose
            ),
            "subject_reference": (
                "PAT-"
                + salted_hmac(
...
def consent_center(request: HttpRequest) -> HttpResponse:
    ...
    decision_labels: dict[str, str] = {
        ConsentManifestation.Decision.ACCEPTED: _("Aceitou"),
        ConsentManifestation.Decision.REFUSED: _("Recusou"),
        ConsentManifestation.Decision.REVOKED: _("Revogou"),
    }
    rows: list[ConsentRow] = [
        {
            ...
            "decision_label": decision_labels.get(decisions.get(document.pk, "")),
