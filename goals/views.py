...
def goal_create(request: HttpRequest) -> HttpResponse:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": _("Nova Meta"),
            "form": form,
            "form_id": "goal-form",
            "submit_label": _("Criar meta"),
        },
    )
...
def goal_detail(request: HttpRequest, goal_id: UUID) -> HttpResponse:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": _("Detalhe da Meta"),
            "goal": goal,
            "horizon_label": GOAL_HORIZON_LABELS.get(goal.horizon, goal.horizon),
            "priority_label": GOAL_PRIORITY_LABELS.get(goal.priority, goal.priority),
            "status_label": GOAL_STATUS_LABELS.get(goal.status, goal.status),
            "steps": steps,
            "done_count": done,
            "total_steps": total,
            "percent": percent,
...
def goal_edit(request: HttpRequest, goal_id: UUID) -> HttpResponse:
    ...
    return TemplateResponse(
        ...
        {
            "layout_template": "layouts/vertical.html",
            "page_title": _("Editar Meta"),
            "form": form,
            "form_id": "goal-edit-form",
            "submit_label": _("Salvar alterações"),
        },
    )
