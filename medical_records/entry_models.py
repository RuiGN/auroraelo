...
class MedicalRecordEntry(UUIDTimestampedModel):
    ...
    infrastructure_objects = InfrastructureMedicalRecordsManager["MedicalRecordEntry"]()
...
class RecordEntryVersion(UUIDTimestampedModel):
    ...
    infrastructure_objects = InfrastructureMedicalRecordsManager["RecordEntryVersion"]()
